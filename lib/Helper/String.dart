...
final Uri updateSellerStatusApi = Uri.parse(baseUrl + 'update_status');
...
final Uri updateProductsApi = Uri.parse(baseUrl + 'update_product_status');
...
final Uri getUserApi = Uri.parse(baseUrl + 'get_fuid');
...
final Uri acceptStatusApi = Uri.parse(baseUrl + 'accept_reject_order');
final Uri planApi = Uri.parse(baseUrl + 'plan_all_info');
